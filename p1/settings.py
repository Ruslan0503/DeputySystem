...
SECRET_KEY = 'django-insecure-!evln7k+^9ai6ybwm_6w#km59b76za29cx88vtb298i$(e6p@4'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1),  # Example, set as needed
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),    # Refresh token lifetime
}

# REST_FRAMEWORK = {
#     'DEFAULT_PERMISSION_CLASSES': [
#         'rest_framework.permissions.IsAuthenticated',  # Or another appropriate permission
#     ],
# }
